...
Namespace S130362
    ...
    Public Partial Class Form1
        ...
        Private Sub button1_Click(ByVal sender As Object, ByVal e As EventArgs)
            ...
            If pageSettings.PaperSize.Width <> 0 AndAlso pageSettings.PaperSize.Height <> 0 Then link.CustomPaperSize = New Size(pageSettings.PaperSize.Width, pageSettings.PaperSize.Height)
